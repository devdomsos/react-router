...
export const JSCourses = [
  ...
  },
  {
    ...
    description: "In this course we will create a command line application to retrieve user's profile information from a website. We'll be writing our application in JavaScript to run on the Node.js platform.",
